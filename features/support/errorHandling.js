...
exports.ifErrorTakeScreenshot = function (resolvedTestController) {
    var tcScreenshotCapturer = testController.testRun.browserManipulationQueue.screenshotCapturer
    var screenshotPath = tcScreenshotCapturer.baseDirName + "\\test-" + tcScreenshotCapturer.testIndex + "\\" + tcScreenshotCapturer.userAgentName + "\\errors\\" + tcScreenshotCapturer.errorScreenshotIndex + ".png"
